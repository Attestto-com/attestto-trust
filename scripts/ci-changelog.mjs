 ...
 *   1. Any shipped source file changed (see SOURCE_PATHS) but CHANGELOG.md did not.
 ...
 *
 * Skips entirely when the PR author is dependabot[bot], or when no shipped source
 * file changed.
 *
...
const SOURCE_PATHS = ['countries/', 'anchors/', 'index.js', 'index.d.ts'];
...
// --- check 1: shipped source changed, CHANGELOG.md did not -----------------
